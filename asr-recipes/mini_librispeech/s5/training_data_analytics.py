...
dict_path = "/other/users/konspat/asr-tts-class-2021/asr-recipes/mini_librispeech/s5/corpus"
train_dev_files = [0,0]
...
for i,dataset in enumerate(sets):
    for dir_name,dirs,files in os.walk(dataset):
        for file_n in files:
            ...
            if ".flac" in file_n:
                train_dev_files[i]+=1
                duration = subprocess.run(["soxi","-D",filepath], stout=subprocess.PIPE, stderr=subprocess.PIPE)
